...
public class Round extends BlockCipher {
    ...
    public Round(String charKey, boolean encrypt) {
    ...
    public void crypt(byte[] data, int offset) {
        ...
        int r3 = mul(x4, subKey[k]);


        data[offset + 0] = (byte) (r0) ;
        data[offset + 1] = (byte) r1;
        data[offset + 2] = (byte) (r2 );
        data[offset + 3] = (byte) r3;
    ...
    private static int mulInv1(int x) {
        if (x <= 1) {
