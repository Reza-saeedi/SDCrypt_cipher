...
import com.cryptography.sdcrypt_cipher.modes.algorithms.CBC;
import com.cryptography.sdcrypt_cipher.modes.algorithms.CFB;
import com.cryptography.sdcrypt_cipher.modes.algorithms.ECB;
import com.cryptography.sdcrypt_cipher.modes.algorithms.OFB;
...
public class FileCipher extends Task<Void> {
    ...
    private void cryptFile() throws IOException {
        ...
        try (FileChannel inChannel = FileChannel.open(Paths.get(input), StandardOpenOption.READ);
            ...
            status.setValue("Running Algorithm...");
            ...
            if (encrypt) {
                ...
                long dataSize =inDataLen; readDataLength(inChannel, opMod);
